...
trainset = torchvision.datasets.Cityscapes('/local/DEEPLEARNING/cityscapes', split='train', mode='fine',
...
trainset = torchvision.datasets.Cityscapes('/local/DEEPLEARNING/cityscapes', split='test', mode='fine',
                     target_type='semantic')
